        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <Link to="/admin" className="text-gray-400 hover:text-primary transition-colors w-fit">Admin Login</Link>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href={`tel:${company.contact.phone}`} className="hover:text-white transition-colors">{company.contact.phone}</a>
              </li>
              <li className="flex items-center gap-3">
