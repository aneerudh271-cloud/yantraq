...
export const pageKeywords = {
    ...
    products: [
        ...
        'refurbished laptop bhopal', 'used laptop bhopal',
        ...
        'Lenovo laptop dealer bhopal', 'Hikvision CCTV dealer bhopal',
        'CP Plus CCTV dealer bhopal', 'enterprise server bhopal',
        'workstation bhopal', 'server rack bhopal',
    ...
    services: [
        ...
        'mobile app development service bhopal', 'software development service bhopal',
        'SEO services bhopal', 'AEO services bhopal', 'GEO services bhopal',
        'digital marketing services bhopal', 'custom software bhopal',
        'IT consulting bhopal', 'managed IT services bhopal',
